...
namespace Project.Infrastructure.Implementation.Query
{
    public class UserQueryRepository : QueryRepository<User>, IUserQueryRepository
    {
        ...
        public UserQueryRepository(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
            _applicationDbContext = applicationDbContext;
        }
        // Implement additional methods specific to UserQueryRepository here
    }
}
